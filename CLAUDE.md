...
Superpowers specs and plans go in `.claude/working/` (gitignored), not `docs/`. These are working files for Claude, not project documentation. Git tracks changes, `docs/` has living documentation.
