...
- User-facing package, widget, and editor strings are resource-backed. The package and UWP widget use `Strings\<language>\Resources.resw`; the WPF companion editor uses `Resources\Strings*.resx`.
