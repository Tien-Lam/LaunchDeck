...
expected and is called out in the summary.
...
The trusted workflow fetches GitHub's authoritative rendered `body_html` and
accepts only a genuinely top-level rendered H2 followed by top-level rendered
